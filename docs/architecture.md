...
| Isolated multi-format parser groundwork, quarantine, upstream-signed malware-snapshot admission, parser-worker, and normalized-output slice; Demo Day product admission remains PDF-only under the PRD | [ingestion package guide](../packages/ingestion/README.md), [supervisor service](../packages/ingestion/src/service.ts), [upstream snapshot publisher](../packages/ingestion/src/adapters/clamav-snapshot-publisher.ts), [runtime admission and scanner](../packages/ingestion/src/adapters/clamav.ts), [worker entry point](../packages/ingestion/worker/src/main/java/com/reflo/ingestion/WorkerMain.java), and [worker policy tests](../packages/ingestion/src/worker-image-policy.test.ts) | [ADR 0044](adrs/0044-serverless-isolated-ingestion-task-for-demo-day-dev.md), [ADR 0020](adrs/0020-java-25-base-family-for-the-isolated-ingestion-worker.md), and [ADR 0035](adrs/0035-upstream-signed-clamav-cloud-demo-snapshot-admission.md) |
