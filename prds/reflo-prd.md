...
**Version:** 1.6 · **Date:** July 17, 2026 · **Status:** Approved for build sprint
**Changelog:** v1.6 — decision authority split by role: this PRD controls product requirements and mandates, GitHub issues authorize implementation/process choices, and merged `DECISIONS.md` records make those verdicts effective and searchable
