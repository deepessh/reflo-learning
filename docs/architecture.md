...
| [ADR 0037](adrs/0037-doubled-bounded-curriculum-deadline-policy.md) | Doubled bounded curriculum deadline policy | `D-GH-187` | ADR |
...
- Model and media capabilities:
  ...
  and [ADR 0037](adrs/0037-doubled-bounded-curriculum-deadline-policy.md).
