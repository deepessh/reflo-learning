...
outbox publisher and dead-letter destination. The revised conservative BOM is
USD 401.14/month, so it also requires an owner-approved cost reduction or a new
