...
export const CURRICULUM_PARENT_DEADLINE_MS = 240_000 as const;
export const CURRICULUM_SEGMENT_DEADLINE_MS = 60_000 as const;
export const CURRICULUM_FINALIZATION_RESERVE_MS = 24_000 as const;
