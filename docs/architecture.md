...
| [ADR 0047](adrs/0047-operator-hosted-connected-demo-day-runtime.md) | Operator-hosted connected Demo Day runtime | `D-GH-214` | ADR |
...
- Repository, delivery, and infrastructure boundaries:
  ...
  [ADR 0047](adrs/0047-operator-hosted-connected-demo-day-runtime.md),
...
- Content trust, scope, and retrieval:
  ...
  [ADR 0047](adrs/0047-operator-hosted-connected-demo-day-runtime.md),
  [ADR 0044](adrs/0044-serverless-isolated-ingestion-task-for-demo-day-dev.md),
...
| Pinned local application images, bounded schema setup, DML-only API database role, bounded jobs startup execution, loopback-only Compose application profile, and scoped lifecycle slice | [Compose profile](../compose.yaml), [database setup](../packages/db/scripts/prepare-local-app-profile.mjs), [web image](../apps/web/Dockerfile), [API image](../apps/api/Dockerfile), [jobs image](../apps/jobs/Dockerfile), [jobs development runner](../apps/jobs/src/development-runner.ts), [lifecycle helper](../scripts/local-apps.sh), and [container policy](../scripts/check-app-containers.mjs) | [ADR 0002](adrs/0002-workspace-tooling-and-deployable-service-boundaries.md), [ADR 0003](adrs/0003-sql-migrations-schema-ownership-and-write-boundaries.md), [ADR 0034](adrs/0034-connected-online-demo-day-scope.md), and [ADR 0047](adrs/0047-operator-hosted-connected-demo-day-runtime.md) |
...
| Langfuse and SLS OTLP trace adapter, closed-schema, and composition-wiring slice | [observability package guide](../packages/observability/README.md), [closed trace schema](../packages/observability/src/contracts.ts), [Langfuse adapter](../packages/observability/src/adapters/langfuse.ts), [SLS adapter](../packages/observability/src/adapters/sls.ts), and [adapter/schema tests](../packages/observability/src/observability.test.ts) | [ADR 0004](adrs/0004-provider-capability-ports-and-adapter-rollout.md), [ADR 0010](adrs/0010-typed-model-routing-prompt-provenance-retry-and-trace-contract.md), [ADR 0024](adrs/0024-shared-traced-model-routing-module.md), [ADR 0031](adrs/0031-versioned-privacy-lifecycle-and-deletion-control-plane.md), and [ADR 0034](adrs/0034-connected-online-demo-day-scope.md) |
...
| Isolated multi-format parser groundwork, quarantine, upstream-signed malware-snapshot admission, local Podman worker, roleless Function Compute session transport/runtime/packaging, and normalized-output slice; Demo Day product admission remains PDF-only under the PRD | [ingestion package guide](../packages/ingestion/README.md), [supervisor service](../packages/ingestion/src/service.ts), [FC session adapter](../packages/ingestion/src/adapters/function-compute-session.ts), [FC custom runtime](../packages/ingestion/worker/src/main/java/com/reflo/ingestion/FunctionRuntimeMain.java), [upstream snapshot publisher](../packages/ingestion/src/adapters/clamav-snapshot-publisher.ts), [deployment packaging](../scripts/prepare-dev-deployment-artifacts.sh), and [infrastructure policy](../scripts/check-infra-policy.mjs) | [ADR 0044](adrs/0044-serverless-isolated-ingestion-task-for-demo-day-dev.md), [ADR 0047](adrs/0047-operator-hosted-connected-demo-day-runtime.md), [ADR 0020](adrs/0020-java-25-base-family-for-the-isolated-ingestion-worker.md), and [ADR 0035](adrs/0035-upstream-signed-clamav-cloud-demo-snapshot-admission.md) |
...
| Bounded section-aware curriculum partitioning, traced child routing, durable replay, and deterministic composition slice | [curriculum partition and composition](../packages/retrieval/src/curriculum.ts), [orchestration service](../packages/retrieval/src/service.ts), [PostgreSQL adapter](../packages/db/src/content-repository.ts), [repository integration test](../packages/db/test/content-repository.test.mjs), and [router contract tests](../packages/model-router/src/router.test.ts) | [ADR 0007](adrs/0007-layered-owner-scope-enforcement.md), [ADR 0009](adrs/0009-versioned-source-span-embedding-and-vector-namespace-contract.md), [ADR 0010](adrs/0010-typed-model-routing-prompt-provenance-retry-and-trace-contract.md), [ADR 0012](adrs/0012-durable-event-idempotency-retry-dlq-and-finalization-contract.md), [ADR 0024](adrs/0024-shared-traced-model-routing-module.md), and [ADR 0036](adrs/0036-bounded-structure-aware-curriculum-segments-and-deterministic-composition.md) |
...
| Repository-owned evaluation contracts and attestation index slice, retained as inactive post–Demo Day qualification capability under PRD v2.7 | [evaluation package guide](../packages/evaluation/README.md), [attestation implementation](../packages/evaluation/src/attestation.ts), and [gate index](../packages/db/src/gate-attestation-index.ts) | [ADR 0042](adrs/0042-deferred-release-qualification-activation-and-retained-v2-evidence.md) |
| Adaptive question selection, versioned whole-attempt grading, and replay-safe keyed fallback slice | [assessment package guide](../packages/assessment/README.md), [assessment service](../packages/assessment/src/service.ts), [PostgreSQL adapter](../packages/db/src/assessment-repository.ts), and [integration test](../packages/db/test/assessment-repository.test.mjs) | [ADR 0010](adrs/0010-typed-model-routing-prompt-provenance-retry-and-trace-contract.md), [ADR 0012](adrs/0012-durable-event-idempotency-retry-dlq-and-finalization-contract.md), [ADR 0030](adrs/0030-versioned-grading-abstention-fallback-and-fsrs-rating-contract.md) |
| Stored-evidence online Tutor Agent, bounded re-teach loop, grounded tutor citations, and durable Flow B summary slice | [Tutor Agent package guide](../packages/tutor-agent/README.md), [orchestrator service](../packages/tutor-agent/src/service.ts), [PostgreSQL adapter](../packages/db/src/tutor-agent-repository.ts), [repository integration test](../packages/db/test/tutor-agent-repository.test.mjs), and [authenticated API test](../apps/api/src/server.test.ts) | [ADR 0007](adrs/0007-layered-owner-scope-enforcement.md), [ADR 0009](adrs/0009-versioned-source-span-embedding-and-vector-namespace-contract.md), [ADR 0010](adrs/0010-typed-model-routing-prompt-provenance-retry-and-trace-contract.md), [ADR 0012](adrs/0012-durable-event-idempotency-retry-dlq-and-finalization-contract.md), [ADR 0016](adrs/0016-provisional-bayesian-mastery-and-reproducibility-contract.md), [ADR 0025](adrs/0025-versioned-bayesian-mastery-and-fsrs-scheduling.md), and [ADR 0033](adrs/0033-pinned-fsrs6-scheduler-profile-and-deterministic-replay.md) |
