...
export const CURRICULUM_PARENT_DEADLINE_MS = 120_000 as const;
export const CURRICULUM_SEGMENT_DEADLINE_MS = 30_000 as const;
export const CURRICULUM_FINALIZATION_RESERVE_MS = 12_000 as const;
