...
| Pinned local application images, bounded schema setup, loopback-only Compose application profile, and scoped lifecycle slice | [Compose profile](../compose.yaml), [web image](../apps/web/Dockerfile), [API image](../apps/api/Dockerfile), [jobs image](../apps/jobs/Dockerfile), [lifecycle helper](../scripts/local-apps.sh), and [container policy](../scripts/check-app-containers.mjs) | [ADR 0002](adrs/0002-workspace-tooling-and-deployable-service-boundaries.md), [ADR 0003](adrs/0003-sql-migrations-schema-ownership-and-write-boundaries.md), and [ADR 0034](adrs/0034-connected-online-demo-day-scope.md) |
