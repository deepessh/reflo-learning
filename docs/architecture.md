...
| [ADR 0036](adrs/0036-bounded-structure-aware-curriculum-segments-and-deterministic-composition.md) | Bounded structure-aware curriculum segments and deterministic composition | `D-GH-181` | ADR |
...
- Model and media capabilities:
  ...
  and [ADR 0036](adrs/0036-bounded-structure-aware-curriculum-segments-and-deterministic-composition.md).
